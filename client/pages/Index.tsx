    ...
    <div className="w-full bg-white">
      ...
      <section className="flex flex-col items-center gap-20 py-20 px-4 md:px-10 rounded-[32px] bg-gradient-to-b from-transparent to-white overflow-hidden my-10">
        <div className="flex flex-col items-center gap-20">
          <img src="https://api.builder.io/api/v1/image/assets/TEMP/8d0229861657530accf6f88311950ca9a4d5d8fd?width=1990" alt="Execution Layer" className="w-full max-w-4xl h-auto" />
