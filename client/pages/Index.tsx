    ...
    <div className="w-full bg-white">
        ...
        <div className="relative z-10 flex flex-col items-center gap-20 py-20 px-5">
          ...
          <nav className="flex items-center gap-8 px-3 py-3 rounded-[20px]">
            ...
            <div className="flex items-center gap-5 px-2.5">
              <Link
                to="#"
                className="font-inter-tight text-sm font-medium text-black"
              >
                Customers
              </Link>
              <Link
          ...
          <div className="flex flex-col items-center gap-5 max-w-[1034px] w-full px-4">
            <div className="flex flex-col items-center gap-8 w-full">
              <h1
                style={{
                  font: '600 96px/120% "Inter Tight", -apple-system, Roboto, Helvetica, sans-serif',
                  backgroundClip: "text",
                  backgroundImage:
                    "linear-gradient(rgb(0, 0, 0), rgb(51, 51, 51))",
                  color: "rgba(0, 0, 0, 0)",
              ...
              >
                ...
                infrastructure — decentralized or cloud — and guarantee it
                finishes.
              </p>
            </div>
      ...
      <div className="flex items-center justify-center py-12 px-4 overflow-hidden bg-white">
        <div className="flex items-center gap-12 md:gap-16 lg:gap-24 flex-wrap justify-center max-w-7xl">
          <img
            src="https://api.builder.io/api/v1/image/assets/TEMP/33e89fb12180183a6dd30eb6a70971443d9d6a9f?width=137"
            alt="Salesforce"
            className="h-12 w-auto opacity-80 hover:opacity-100 transition-opacity"
          />
          <img
            src="https://api.builder.io/api/v1/image/assets/TEMP/ad33659c33381eac40061641b81f19d65a13ad9f?width=223"
            alt="Vimeo"
      ...
      <section className="flex flex-col items-center gap-20 py-20 px-4 md:px-10 rounded-[32px] border border-[#F1F1F1] bg-gradient-to-b from-transparent via-white to-white/40 overflow-hidden my-10">
        <div className="flex flex-col items-center gap-5 max-w-4xl">
          ...
          <p className="max-w-[646px] text-center font-inter-tight text-lg md:text-xl font-medium leading-[140%] text-black">
            You define what needs to run and what matters (deadline, budget,
            region). We handle where it runs, how it's verified, and what
            happens if it fails — automatically.
          </p>
        </div>
          ...
          <div className="p-2.5 rounded-[32px] border border-[#E4E7EC] bg-black/5 backdrop-blur-sm">
            ...
            <div className="flex flex-col md:flex-row gap-2.5 mb-2.5">
              <div className="flex-1 flex flex-col items-start gap-10 p-10 rounded-3xl border border-[#E4E7EC] bg-white">
                <div className="flex flex-col items-start gap-2.5">
                  ...
                  <p className="font-inter-tight text-xl font-medium leading-[140%] text-black">
                    Start with a screen recording or a statically uploaded file
                  </p>
                </div>
                <img
                  src="https://api.builder.io/api/v1/image/assets/TEMP/4bdcd61008dc68115564026baab99d13249735a6?width=1072"
                  alt="Upload"
              ...
              <div className="flex-1 flex flex-col items-start gap-10 p-10 rounded-3xl border border-[#E4E7EC] bg-white">
                <div className="flex flex-col items-start gap-2.5">
                  ...
                  <p className="font-inter-tight text-xl font-medium leading-[140%] text-black">
                    Watch as the Atlas helps you find the exact origin of the
                    media derived from your source
                  </p>
                </div>
                <img
                  src="https://api.builder.io/api/v1/image/assets/TEMP/5c380b76afab7934571c8c24b203c2ea80fd9333?width=1072"
                  alt="Identify"
                  className="w-full h-auto rounded-lg"
                />
              </div>
            ...
            <div className="flex flex-col p-10 gap-10 rounded-3xl border border-[#E4E7EC] bg-white">
              <div className="max-w-md">
                ...
                <button className="flex items-center justify-center gap-2 px-4 py-3.5 rounded-xl bg-[#212121] border-t-2 border-[#333] shadow-[0_-3px_0_0_#1A1A1A_inset,0_0_0_1px_#1A1A1A]">
                  <span className="font-inter-tight text-sm font-medium text-white">
                    Preorder for $40
                  </span>
                </button>
              </div>
      ...
      <section className="flex flex-col items-center gap-20 py-20 px-4 md:px-10 rounded-[32px] bg-gradient-to-b from-transparent to-white overflow-hidden my-10">
        <div className="flex flex-col items-center gap-20">
          ...
          <div className="flex flex-col items-center gap-5 max-w-4xl">
            ...
            <p className="max-w-[646px] text-center font-inter-tight text-lg md:text-xl font-medium leading-[140%] text-black">
              We unify centralized clouds and decentralized compute into one
              execution fabric. Jobs run on the most cost-effective resources
              first, with automatic fallback to trusted providers when
              reliability matters.
            </p>
          </div>
        </div>
          ...
          <div className="flex flex-col gap-2.5">
            ...
            <div className="flex flex-col md:flex-row gap-2.5">
              <div className="flex-1 flex flex-col items-start gap-10 p-10 rounded-3xl border border-[#E4E7EC] bg-white">
                <div className="flex flex-col items-start gap-2.5">
                  ...
                  <p className="font-inter-tight text-xl font-medium leading-[140%] text-black">
                    Generate anything from static images to animated videos with
                    a single prompt. Embrace the true potential of creative
                    diversity.
                  </p>
                </div>
                <img
                  src="https://api.builder.io/api/v1/image/assets/TEMP/65b822875e0835aac59e48e21298d6ba52654539?width=688"
                  alt="Multi-Media"
                  className="w-full h-auto"
                />
              </div>
              <div className="md:w-[808px] flex flex-col items-start gap-10 p-10 rounded-3xl border border-[#E4E7EC] bg-white">
                <div className="max-w-lg flex flex-col items-start gap-2.5">
                  ...
                  <p className="font-inter-tight text-xl font-medium leading-[140%] text-black">
                    Within seconds, see your ideas turn into reality. No more
                    waiting for inspiration to strike.
                  </p>
                </div>
                <img
                  src="https://api.builder.io/api/v1/image/assets/TEMP/166d218f50c9a3d1bb25238a7660bc45fc7061c9?width=1456"
                  alt="Speed"
                  className="w-full h-auto rounded-3xl border border-[#F1F1F1]"
                />
              </div>
            </div>
            ...
            <div className="flex flex-col md:flex-row gap-2.5">
              <div className="flex-1 flex flex-col items-start gap-10 p-10 rounded-3xl border border-[#E4E7EC] bg-white">
                <div className="flex flex-col items-start gap-2.5">
                  <h3 className="font-inter-tight text-3xl font-semibold leading-[150%] text-black">
                    Advanced Creation Analytics
                  </h3>
                  <p className="font-inter-tight text-xl font-medium leading-[140%] text-black">
                    Our advanced analytics tools track your most used prompts
                    and successful outputs, giving you valuable insights into
                    your creative trends and preferences.
                  </p>
                </div>
                <img
                  src="https://api.builder.io/api/v1/image/assets/TEMP/01ae270fb6e0b1552f8b3aa8b42f25d118813a69?width=1072"
                  alt="Analytics"
              ...
              <div className="flex-1 flex flex-col items-start gap-10 p-10 rounded-3xl border border-[#E4E7EC] bg-white">
                <div className="flex flex-col items-start gap-2.5">
                  ...
                  <p className="font-inter-tight text-xl font-medium leading-[140%] text-black">
                    Start with up to 100 free prompts when you sign up. Explore
                    and experiment without limits.
                  </p>
                </div>
                <img
                  src="https://api.builder.io/api/v1/image/assets/TEMP/8fb774637cb9b4ea4fe8fa93749c9e65d370573c?width=1072"
                  alt="Free Prompts"
                  className="w-full h-auto rounded-xl border border-[#F1F1F1]"
                />
              </div>
            </div>
            ...
            <div className="flex flex-col items-start gap-10 p-10 rounded-3xl border border-[#E4E7EC] bg-white">
              <div className="max-w-3xl flex flex-col items-start gap-2.5">
                ...
                <p className="font-inter-tight text-xl font-medium leading-[140%] text-black">
                  Creativity is often a team effort. Invite team members to join
                  your workspace for real-time collaboration. Share prompts,
                  provide feedback, and create collectively.
                </p>
              </div>
              <img
      ...
      <section className="flex flex-col items-center gap-20 py-20 px-4 md:px-10 rounded-[32px] border border-[#F1F1F1] bg-gradient-to-b from-transparent via-white to-white/40 overflow-hidden my-10">
        <div className="max-w-4xl flex flex-col items-center gap-5">
          ...
          <p className="max-w-[646px] text-center font-inter-tight text-lg md:text-xl font-medium leading-[140%] text-black">
            Make informed decisions with real execution data. Track job
            completion rates, retries, fallbacks, and cost efficiency — all
            without managing infrastructure or vendor lock-in.
          </p>
        </div>
        ...
        <div className="w-full max-w-7xl p-2.5 rounded-[32px] border border-[#E4E7EC] bg-black/5 backdrop-blur-sm">
          <div
            ...
            style={{
              backgroundImage:
                "url('https://api.builder.io/api/v1/image/assets/TEMP/698276ae2d8ac9026c9e7b52cafa82dc924aac55?width=2520')",
            }}
          >
      ...
      {/* CTA Section */}
      <section
        className="flex flex-col items-center gap-16 py-20 px-2 md:px-10 pt-20 pb-2.5 rounded-[32px] bg-cover bg-center bg-[#121212] overflow-hidden my-10"
        style={{
          backgroundImage:
            "url('https://api.builder.io/api/v1/image/assets/TEMP/8d3ea67259f0ca31e920a54537772406d4071a7a?width=2800')",
        }}
      >
        <div className="flex flex-col items-center gap-10">
          ...
          <div className="flex flex-col items-center gap-5 max-w-2xl">
            ...
            <p className="max-w-[455px] text-center font-inter-tight text-xl font-medium leading-[140%] text-white">
              Talk to the founder · Join as a design partner · Tell us about
              your workload
            </p>
            <button className="flex items-center justify-center gap-2 px-4 py-3.5 rounded-xl bg-white border-t-2 border-[#E6E6E6] shadow-[0_-3px_0_0_#E6E6E6_inset,0_0_0_1px_#E6E6E6]">
              <span className="font-inter-tight text-sm font-medium text-[#121212]">
                Preorder for $40
              </span>
            </button>
          </div>
        ...
        <div className="w-full flex flex-col md:flex-row items-start justify-center gap-12 md:gap-48 p-20 rounded-[22px] border border-[#262626] bg-gradient-to-b from-[#121212] to-[#1A1A1A]">
          <div className="flex flex-col items-start gap-5 max-w-md">
            <div className="flex items-center gap-4">
              ...
              <span className="font-inter-tight text-2xl font-semibold text-white">
                Atlas
              </span>
            </div>
          ...
          <div className="flex items-start justify-center gap-12 md:gap-48">
            <div className="flex flex-col items-start gap-10">
              <span className="font-inter-tight text-2xl font-medium text-white">
                Menu
              </span>
              <div className="flex flex-col items-start gap-5">
                <Link
                  to="#"
                  className="font-inter-tight text-lg font-medium text-[#999]"
                >
                  Home
                </Link>
                <Link
